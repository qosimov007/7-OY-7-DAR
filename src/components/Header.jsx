        ...
        <header>
            <div className="header-top bg-neutral">
                <div className="w-3/5 mx-auto py-2 flex gap-5 justify-end">
                    ...
                    <Link to='/register' className="text-sm text-slate-300 hover:underline">Create account</Link>
                ...
                <div className="w-3/5 mx-auto">
                    <div className="navbar ">
                        <div className="navbar-start">
                            <Link to='/' className={`btn ${theme.theme == 'light' ? 'btn-info' : 'btn-secondary'} text-2xl hover:opacity-70`}>C</Link>
                        </div>
